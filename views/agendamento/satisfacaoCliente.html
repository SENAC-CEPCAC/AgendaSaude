 ...
 <div class="w-full max-w-2xl mx-auto">
    ...
    <div class="mb-8">
      ...
      <textarea
        ...
        class="w-full border border-gray-300 rounded-lg p-4 text-gray-700 placeholder-gray-400 resize-none focus:outline-none focus:ring-2 focus:ring-blue-800 focus:border-transparent"
      ></textarea>
    </div>
