              ...
              <tr class="hover:bg-slate-50/60 transition-colors">
                ...
                <td class="py-4 px-5 text-center">
                  <div class="flex items-center justify-center gap-1.5">
                    ...
                    <!-- Preencher Anamnese (Colo ou Mama, conforme o exame) -->
                    <a
                      href="{{ route($ehMamografia ? 'anamnese-mama.create' : 'anamnese-colo.create', $agendamento->id_prontuario) }}"
                      class="p-1.5 bg-emerald-50 hover:bg-emerald-100 text-emerald-700 rounded-lg transition-colors"
      ...
      <form id="form-avaliacao-documento" method="POST" action="" class="space-y-4">
        ...
        <div id="box-motivo-rejeicao" class="hidden">
          ...
          <textarea
            ...
            class="w-full bg-slate-50 border border-slate-200 rounded-lg p-2.5 text-xs text-slate-700 focus:outline-none focus:border-blue-900"></textarea>
        </div>
