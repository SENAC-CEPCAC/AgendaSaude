   ...
   <form class="w-full max-w-xl mx-auto">
    ...
    <div class="mt-6">
      ...
      <textarea
        ...
        class="w-full rounded-xl border border-gray-300 p-4 text-sm text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#0B3B66] focus:border-transparent resize-none"
      ></textarea>
    </div>
