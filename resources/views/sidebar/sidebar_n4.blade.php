    ...
    <div>
        ...
        <nav class="flex flex-col fixed left-0 top-0 h-screen py-6 bg-white dark:bg-slate-900 h-full w-64 border-r border-r border-slate-200 dark:border-slate-800 z-40">
            ...
            <ul class="flex-1 flex flex-col gap-2 px-3">
                ...
                <li>
                    <a href="{{ route('anamnese-dia.index') }}" class="flex items-center gap-3 px-14 py-3 rounded-lg text-slate-500 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 font-['Inter'] text-sm font-medium hover:text-[#003E7E] dark:hover:text-blue-300 transition-all active:scale-95 transition-transform">
                        <span class="material-symbols-outlined"></span>
                        Relatórios
                    </a>
                </li>
