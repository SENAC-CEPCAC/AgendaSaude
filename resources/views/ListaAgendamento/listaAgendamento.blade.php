...
<html lang="pt-BR">
  <head>
    ...
    <title>Triagem Administrativa N1 - Lista de Agendamentos</title>
      ...
      <main id="main-content" class="min-h-screen flex-1 flex flex-col p-4 md:p-8 md:ml-64">
        ...
        <header id="top-bar" class="h-16 bg-white border border-slate-200/80 px-4 md:px-6 flex items-center justify-between sticky top-4 z-20 shadow-sm rounded-xl mb-6">
          <div class="flex items-center gap-3">
            <div id="breadcrumb" class="flex items-center gap-2 text-xs text-slate-400 font-medium">
              ...
              <span>/</span>
              <span class="text-slate-700 font-semibold">Triagem de Agendamentos & Documentos</span>
            </div>
          </div>
        ...
        <div class="max-w-7xl w-full mx-auto space-y-6">
          ...
          <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              <h1 class="text-2xl font-bold text-slate-900">Triagem de Agendamentos (N1)</h1>
          ...
          <!-- Tabela de Agendamentos e Triagem N1 -->
                  ...
                  <tr class="hover:bg-slate-50/60 transition-colors">
                    ...
                    <td class="py-4 px-5">
                      <div class="font-bold text-slate-800">
                        {{ $agendamento->paciente ? $agendamento->paciente->nome_completo : 'Paciente #' . $agendamento->id_paciente }}
                      </div>
                      <div class="text-xs text-slate-400 font-mono mt-0.5">
                        CPF: {{ $agendamento->paciente ? $agendamento->paciente->cpf : 'Não informado' }}
                      </div>
                    </td>
