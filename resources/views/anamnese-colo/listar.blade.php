...
<x-layout>
  <div class="mx-auto max-w-6xl px-8 py-8">
    ...
    <form method="GET" action="{{ route('anamnese-colo.index') }}" class="mb-4 flex gap-3">
      <input
        type="text"
        name="cpf"
        value="{{ $cpfBusca }}"
      ...
      @if ($cpfBusca)
        <a href="{{ route('anamnese-colo.index') }}" class="flex items-center px-3 text-sm font-medium text-slate-500 hover:text-slate-700">
          Limpar busca
        </a>
      @endif
    </form>
              ...
              <tr class="hover:bg-slate-50">
                ...
                <td class="px-6 py-3">
                  <div class="flex items-center justify-end gap-3">
                    ...
                    <a href="{{ route('anamnese-colo.pdf', $anamnese->id_siscolo) }}"
