        ...
        <aside id="sidebar" class="fixed top-0 left-0 bottom-0 w-64 bg-[#0a0f1d] border-r border-slate-800 flex flex-col justify-between text-slate-300 z-50 transition-transform duration-300 transform -translate-x-full">
          <div>
            ...
            <div id="brand-header" class="p-6 border-b border-slate-800/80 flex items-center justify-between">
              <div class="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p id="brand-role" class="text-[10px] text-slate-400 font-semibold uppercase tracking-wider"></p>
                </div>
              </div>
            ...
            <nav id="nav-menu" class="p-4 space-y-1">
              ...
              <a id="nav-patients" href="acesso_restrito.html" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-400 hover:text-white hover:bg-slate-800/50 transition-all font-medium text-sm">
              ...
              <a id="nav-patients" href="colaborador.html" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-400 hover:text-white hover:bg-slate-800/50 transition-all font-medium text-sm">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-lucide="users-round" aria-hidden="true" class="lucide lucide-users-round w-4.5 h-4.5 text-slate-500"><path d="M18 21a8 8 0 0 0-16 0"></path><circle cx="10" cy="8" r="5"></circle><path d="M22 20c0-3.37-2-6.5-4-8a5 5 0 0 0-.45-8.3"></path></svg>
                <span>Colaborador</span>
              </a>

              <a id="nav-patients" href="paciente.html" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-400 hover:text-white hover:bg-slate-800/50 transition-all font-medium text-sm">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-lucide="users-round" aria-hidden="true" class="lucide lucide-users-round w-4.5 h-4.5 text-slate-500"><path d="M18 21a8 8 0 0 0-16 0"></path><circle cx="10" cy="8" r="5"></circle><path d="M22 20c0-3.37-2-6.5-4-8a5 5 0 0 0-.45-8.3"></path></svg>
                <span>Pacientes</span>
              </a>
          ...
          <header id="top-bar" class="h-16 bg-white border-b border-slate-100 px-6 flex items-center justify-between sticky top-0 z-20 shadow-sm">
            <div class="flex items-center gap-3">
              ...
              <div id="breadcrumb" class="flex items-center gap-2 text-xs text-slate-400 font-medium">
                ...
                <span>/</span>
                <span class="text-slate-600 font-semibold">Acesso Restrito</span>
              </div>
            </div>
        ...
        <div id="root">
          <div id="app-root" class="min-h-screen bg-[#f8fafc] text-slate-800 font-sans antialiased flex">
            ...
            <main id="main-content" class="flex-1 min-h-screen flex flex-col p-8 max-w-7xl mx-auto w-full space-y-6">
              ...
              <!-- TITULO DA PAGINA -->
              <h1 class="text-2xl font-bold uppercase tracking-wide text-[#0f172a]">Acesso Restrito</h1>
              ...
              <div class="bg-white rounded-xl border border-slate-100 p-6 flex flex-col md:flex-row items-center justify-between gap-4 shadow-sm">
                ...
                <div class="relative">
                    <input id="importFileInput" type="file" accept=".xls,.xlsx" class="hidden" />
                    <button id="importButton" class="bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs font-bold uppercase tracking-wider flex items-center gap-2 px-5 py-3.5 rounded-xl shadow-sm transition-all cursor-pointer" type="button">
                      <i data-lucide="upload" class="w-4 h-4"></i> Importar
                    </button>
                    <span id="importFileName" class="hidden absolute left-0 top-full mt-2 text-xs text-slate-500"></span>
                  </div>

                <div class="flex items-center gap-3 w-full md:w-auto justify-end">
                  <select id="filterField" class="bg-white border border-slate-200 text-slate-600 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-sky-500 transition-all cursor-pointer">
                ...
                <table class="w-full text-left border-collapse">
                  <thead>
                    <tr class="bg-slate-50 border-b border-slate-100 text-[11px] font-bold tracking-wider text-slate-500 uppercase">
                      ...
                      <th class="py-4 px-6 w-[16%]">Permissão</th>
                      <th class="py-4 px-6 w-[20%]">Email</th>
                      <th class="py-4 px-6 w-[20%]">Cidade</th>
                      <th class="py-4 px-6 w-[19%] text-center">Ações</th>
                    </tr>
                  </thead>
