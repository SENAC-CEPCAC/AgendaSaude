...
<body class="min-h-screen flex flex-col">
    ...
    <!-- MAIN (pb-36 ajustado para permitir rolagem até o final antes do footer) -->
    <main class="flex-1 flex flex-col items-center mt-[80px] px-4 pb-36">
        ...
        <section class="flex gap-10 md:gap-5 items-center justify-between w-[95%] min-w-[325px] max-w-[1024px] max-h-fit mb-4 px-3 py-10 bg-branco rounded-lg border border-gray-200 shadow-sm hero">
            <div class="max-w-[380px] h-full flex items-center justify-center object-cover rounded-lg overflow-hidden mx-auto border border-gray-200 shadow-sm">
                <img src="https://cdnsesc.azureedge.net/assets/2021/09/sescsaudeimg.jpeg" alt="Sesc Saúde" class="w-[380px] h-full">
            </div>
        ...
        <!-- SESSÃO MISSÃO / VISÃO / VALORES -->
        <section class="flex flex-col md:flex-row gap-4 md:gap-10 items-center justify-around w-[95%] min-w-[325px] max-w-[1024px] max-h-fit my-4 rounded-lg m_s_v">
    ...
    <!-- FOOTER (adicionado bg-branco, z-50 e corrigido os espaçamentos internos) -->
    <footer class="fixed bottom-0 left-0 w-full py-4 bg-branco border-t border-gray-200 shadow-md z-50">
        <div class="max-w-6xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
            
            <ul class="flex flex-wrap justify-center gap-4 text-xs">
                <li><a href="#" class="text-azul transition hover:opacity-75">Terms & Conditions</a></li>
                <li><a href="#" class="text-azul transition hover:opacity-75">Privacy Policy</a></li>
                <li><a href="#" class="text-azul transition hover:opacity-75">Cookies</a></li>
            </ul>

            <ul class="flex justify-center gap-6">
                <li>
                    <a href="#" rel="noreferrer" target="_blank" class="text-azul transition hover:opacity-75">
    ...
    <script src="../../js/home/reacoes.js"></script>
</body>
</html>