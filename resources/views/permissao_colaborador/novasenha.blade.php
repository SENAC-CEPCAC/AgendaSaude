...
<body class="bg-[#f8fafc]">
    ...
    <div class="main flex justify-center items-center h-screen ">
        ...
        <div>
            <h4 class="email text-sm ml-1">Digite uma nova senha:</h4>
            <input class="input input border-1 border-gray-300 rounded-md pl-3" type="password" name="password" id="password"
                placeholder="Insira a nova senha">
            
                
             <h4 class="text-sm mt-4 ml-1">Digite novamente:</h4>
            <input class="input border-1 border-gray-300 rounded-md pl-3" type="password"  name="password" id="password"
